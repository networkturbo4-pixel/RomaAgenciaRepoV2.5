const document = { getElementById: (id) => ({ id: id, classList: { remove: ()=>{}, add: ()=>{} }, style: {}, innerHTML: '', innerText: '', addEventListener: ()=>{}, appendChild: ()=>{} }), createElement: () => ({ classList: { add: ()=>{} }, style: {}, dataset: {}, setAttribute: ()=>{}, appendChild: ()=>{} }), querySelectorAll: () => [], addEventListener: ()=>{} };
...
allTasks = [{ id: 1, title: 'test', status: 'Pendiente', tags: [{name: 'tag', color: '#ff0000'}], assigned_to: [], subtasks: [], attachments: [] }]; renderKanban();