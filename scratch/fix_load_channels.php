...
// Replace DOM REFS
$searchDOM = "    const channelListGroup = $('channel-list-group');\n    const channelListDM = $('channel-list-dm');";
$replaceDOM = "    const channelListUnified = $('channel-list-unified');";
$content = str_replace($searchDOM, $replaceDOM, $content);

// Replace loadChannels function up to "channelListDM.innerHTML ="
$searchLoad = <<<'EOD'
...
$content = str_replace($searchLoad, $replaceLoad, $content);

// Add event listener for filters in init()
...
echo "Fixed loadChannels for unified list and filters\n";
?>
