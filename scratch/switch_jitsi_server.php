...
$contentIndex = str_replace('meet.jit.si', 'meet.ffmuc.net', $contentIndex);
...
$contentJs = str_replace("const domain = 'meet.jit.si';", "const domain = 'meet.ffmuc.net';", $contentJs);
file_put_contents($fileJs, $contentJs);

echo "Switched to free Jitsi server (meet.ffmuc.net)\n";
?>
