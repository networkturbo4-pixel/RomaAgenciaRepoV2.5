        ...
        <div class="view-sidebar">
            ...
            <div class="v-card-sidebar">
                ...
                <div class="deliverables-app-grid">
                    <div class="deliverable-card-item" onclick="<?php echo !empty($project['drive_folder_url']) ? "window.open('" . htmlspecialchars($project['drive_folder_url']) . "', '_blank')" : "openDeliverableModal('Videos Finales & Masters', 'Archivos master en 4K/FHD, ProRes o MP4 en la carpeta de Drive.')"; ?>" title="Abrir Video Master">
                        <div class="deliverable-icon-wrap" style="background: rgba(245, 158, 11, 0.15); color: #f59e0b;">
                            <i class="ph-bold ph-video"></i>
                        </div>
                        <div class="deliverable-info">
                            <span class="name">Video Final & Master</span>
                            <span class="type">MP4 • MOV • 4K</span>
                        </div>
                    </div>

                    <div class="deliverable-card-item" onclick="<?php echo !empty($project['drive_folder_url']) ? "window.open('" . htmlspecialchars($project['drive_folder_url']) . "', '_blank')" : "openDeliverableModal('Guión & Storyboard', 'Guión literario, técnico y storyboard en la carpeta de Drive.')"; ?>" title="Abrir Guión y Storyboard">
                        <div class="deliverable-icon-wrap" style="background: rgba(99, 102, 241, 0.15); color: #818cf8;">
                            <i class="ph-bold ph-file-text"></i>
                        </div>
                        <div class="deliverable-info">
                            <span class="name">Guión & Storyboard</span>
                            <span class="type">PDF • DOCX</span>
                        </div>
                    </div>

                    <div class="deliverable-card-item" onclick="<?php echo !empty($project['drive_folder_url']) ? "window.open('" . htmlspecialchars($project['drive_folder_url']) . "', '_blank')" : "openDeliverableModal('Fotografía & Gráficos', 'Material fotográfico, miniaturas y artes de portada en Drive.')"; ?>" title="Abrir Fotografía">
                        <div class="deliverable-icon-wrap" style="background: rgba(16, 185, 129, 0.15); color: #10b981;">
                            <i class="ph-bold ph-camera"></i>
                        </div>
                        <div class="deliverable-info">
                            <span class="name">Fotografía & Gráficos</span>
                            <span class="type">RAW • JPG • PNG</span>
                        </div>
                    </div>

                    <div class="deliverable-card-item" onclick="<?php echo !empty($project['drive_folder_url']) ? "window.open('" . htmlspecialchars($project['drive_folder_url']) . "', '_blank')" : "openDeliverableModal('Audio & Locución', 'Locuciones en alta fidelidad y pistas de música licenciadas en Drive.')"; ?>" title="Abrir Audio y Música">
                        <div class="deliverable-icon-wrap" style="background: rgba(236, 72, 153, 0.15); color: #ec4899;">
                            <i class="ph-bold ph-speaker-high"></i>
                        </div>
                        <div class="deliverable-info">
                            <span class="name">Audio & Locución</span>
                            <span class="type">WAV • MP3</span>
                        </div>
                    </div>
                </div>
                    ...
                    Swal.fire({
                        ...
                        didOpen: () => {
                            document.getElementById('btn-confirm-save-tmpl').onclick = () => {
                                ...
                                fetch('ajax/ajax_audiovisual.php', {
                                    method: 'POST',
